...
@section('title', 'Ajouter un Film - BlackCine Admin')

@section('content')
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-3xl font-bold text-gray-800">Ajouter un Film</h1>
        <p class="text-gray-600 mt-2">Créez un nouveau film dans votre catalogue</p>
    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="year" id="year" value="{{ old('year', date('Y')) }}" min="1900" max="2100"
                                class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring focus:ring-red-200 focus:ring-opacity-50 transition-colors shadow-sm">
                        </div>
                        <div>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <select name="category" class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring focus:ring-red-200 focus:ring-opacity-50 transition-colors shadow-sm">
                    ...
                    <option value="a_l_affiche">À l'Affiche</option>
                    <option value="a_venir">À venir</option>
                    <option value="par_pays">Par Pays</option>
