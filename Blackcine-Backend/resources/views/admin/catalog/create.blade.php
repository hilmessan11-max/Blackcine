...
@section('title', 'Créer un titre - BlackCine Admin')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Créer un titre</h1>
    <p class="text-gray-600 mt-2">Ajouter un film, une série ou un classique</p>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="synopsis" id="synopsis" rows="4"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('synopsis') }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" name="runtime_minutes" id="runtime_minutes" value="{{ old('runtime_minutes') }}" min="0"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

            <div>
                <label class="block text-gray-700 text-sm font-bold mb-2" for="certification">Classification</label>
                <input type="text" name="certification" id="certification" value="{{ old('certification') }}" placeholder="Ex: PG-13, 16+"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>

            <div class="md:col-span-2">
                <label class="flex items-center">
                    <input type="checkbox" name="is_paid" value="1" {{ old('is_paid') ? 'checked' : '' }} class="mr-2">
            ...
            <div>
                ...
                <input type="number" name="price_cents" id="price_cents" value="{{ old('price_cents') }}" min="0"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
