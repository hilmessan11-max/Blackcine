...
@section('title', 'Bandes-annonces - ' . $serie->title)
...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-2">{{ $serie->title }}</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('admin.series.show', $serie->id) }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-400">
                ← Retour à la série
            </a>
            <a href="{{ route('admin.series.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700">
                Liste séries
            </a>
        </div>
    </div>
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-lg shadow">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-800">{{ $serie->trailers->count() }} Bande(s)-annonce(s)</h2>
            </div>
