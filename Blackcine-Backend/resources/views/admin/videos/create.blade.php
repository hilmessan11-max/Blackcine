...
@section('title', 'Ajouter une vidéo - BlackCine Admin')

@section('content')
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-3xl font-bold text-gray-800">Ajouter une vidéo</h1>
        <p class="text-gray-600 mt-2">Ajoutez une nouvelle vidéo à la vidéothèque</p>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Ex: Bande-annonce officielle..."
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select name="source_type" id="source_type" required
                            ...
                            <option value="youtube" {{ old('source_type') === 'youtube' ? 'selected' : '' }}>YouTube</option>
                            <option value="vimeo" {{ old('source_type') === 'vimeo' ? 'selected' : '' }}>Vimeo</option>
                            <option value="external" {{ old('source_type') === 'external' ? 'selected' : '' }}>Lien externe</option>
                            <option value="upload" {{ old('source_type') === 'upload' ? 'selected' : '' }}>Upload fichier</option>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="asset_id" id="asset_id" value="{{ old('asset_id') }}"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="thumbnail_asset_id" id="thumbnail_asset_id" value="{{ old('thumbnail_asset_id') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-red-500 focus:ring focus:ring-red-200 focus:ring-opacity-50 transition-colors shadow-sm">
                    </div>
                </div>
            </div>
