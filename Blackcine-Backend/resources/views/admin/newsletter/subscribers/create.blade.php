...
@section('title', 'Nouvel Abonné - BlackCine')
...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mt-2">Ajouter un abonné</h1>
    </div>

    <div class="bg-white rounded-lg shadow overflow-hidden max-w-2xl mx-auto">
        <form action="{{ route('admin.newsletter.subscribers.store') }}" method="POST" class="p-6">
            @csrf
